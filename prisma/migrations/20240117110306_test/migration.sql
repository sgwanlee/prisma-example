...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favoriatedById_fkey" FOREIGN KEY ("favoriatedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
